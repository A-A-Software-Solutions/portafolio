    ...
    <div class="row">
      ...
      <div class="about-me container col-md-6">
        <div class="section-title">
          ...
          <p>Lee más acerca de mi</p>
        </div>
        <div class="row">
          <div class="col-lg-4" data-aos="fade-right">
            <img src="<?php base_url() ?>assets/img/fotos/abi.jpg" class="img-fluid" alt="">
          </div>
      ...
      <div class="about-me container col-md-6">
        ...
        <div class="row">
          <div class="col-lg-4" data-aos="fade-right">
            <img src="<?php base_url() ?>assets/img/fotos/alan.jpg" class="img-fluid" alt="">
          </div>
          <div class="col-lg-8 pt-4 pt-lg-0 content" data-aos="fade-left">
            <h3>UI/UX &amp; Desarrollador de Software</h3>
            <p class="fst-italic">
...
<section id="portfolio" class="portfolio">
  <div class="container">
    ...
    <div class="section-title">
      <h2>Portafolio</h2>
      <p>Nuestros trabajos recientes</p>
    </div>
    ...
    <div class="row">
      <div class="col-lg-12 d-flex justify-content-center">
        <ul id="portfolio-flters">
          ...
          <li data-filter=".filter-app">App móvil</li>
