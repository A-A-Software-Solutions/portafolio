...
<div class="credits">
    A&A SOFTWARE SOLUTIONS
</div>

<!-- Vendor JS Files -->
<script src="<?php base_url()?>assets/vendor/purecounter/purecounter_vanilla.js"></script>
...
<script src="<?php base_url()?>assets/vendor/isotope-layout/isotope.pkgd.min.js"></script>
<script src="<?php base_url()?>assets/vendor/swiper/swiper-bundle.min.js"></script>
<script src="<?php base_url()?>assets/vendor/waypoints/noframework.waypoints.js"></script>
